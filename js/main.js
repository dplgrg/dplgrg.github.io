(function($) {
	...
	$('.blog-block, .menu-item').on('click', function() {
	    ...
	    //Portfolio masonry
	    var $container = $('.blog .portfolio-container');
	    $container.isotope({
	        masonry: {
	            columnWidth: '.portfolio-item'
	        },
	    ...
	    $('.blog .filters').on('click', 'li', function() {
	        $('.blog .filters li').removeClass('active');
	        $(this).addClass('active');
	        var filterValue = $(this).attr('data-filter');
	        $container.isotope({ filter: filterValue });
	    });
	...
	function init() {
	    ...
	    var mapOptions = {
	        ...
	        center: new google.maps.LatLng({lat: 42.373222, lng: -72.519852}),
	    ...
	    var marker = new google.maps.Marker({
	        position: new google.maps.LatLng({lat: 42.373222, lng: -72.519852}),
	        map: map,
	        icon: image,
	        draggable: true,
